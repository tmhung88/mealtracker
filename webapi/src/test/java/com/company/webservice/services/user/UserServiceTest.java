...
import static com.company.webservice.services.user.UserMatchers.eq;
...
public class UserServiceTest {
    ...
    public void addUser_ExpectPasswordEncrypted() {
        ...
        when(userRepository.save(UserMatchers.eq(UserMatchers.fields().encryptedPassword("encrypted_one")))).thenReturn(result);
    ...
    public void updateUser_NewPasswordAvailable_ExpectNewEncryptedPassworedSaved() {
        ...
        when(userRepository.save(UserMatchers.eq(UserMatchers.fields().encryptedPassword("new_encrypted")))).thenReturn(result);
    ...
    public void updateUser_NewPasswordMissing_ExpectOldPasswordRemain() {
        ...
        when(userRepository.save(UserMatchers.eq(UserMatchers.fields().encryptedPassword("old_encrypted")))).thenReturn(result);
